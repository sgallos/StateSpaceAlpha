function results = SS_age_pooled_iwp(subjectTable, varargin)
%SS_AGE_POOLED_IWP Step 2 pooled age-axis state-space smoother for alpha power.
%
...
%   mfdb_var    per-subject MFDB variance of alpha_dB, in dB^2
    ...
    parser = inputParser();
    parser.FunctionName = 'SS_age_pooled_iwp';
